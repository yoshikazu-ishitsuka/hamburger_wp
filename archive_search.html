      ...
      <article class="p-visual__archive">
        ...
        <section class="p-visual__archive--card">
          <figure class="p-card__menu">
            <img src="./images/common/img_02.png" alt="チーズバーガーの画像" class="p-card__menu--image">
            <figcaption class="p-card__menu--caption c-background-color--card">
              <h2 class="c-title--card c-font-family--mplus1">見出しが入ります</h2>
          ...
          <figure class="p-card__menu">
            <img src="./images/common/img_02.png" alt="ダブルチーズバーガーの画像" class="p-card__menu--image">
            <figcaption class="p-card__menu--caption c-background-color--card">
              <h2 class="c-title--card c-font-family--mplus1">見出しが入ります</h2>
              <h3 class="c-title--subheading c-font-family--mplus1">小見出しが入ります</h3>
              <p class="c-text--card c-font-family--mplus1">
          ...
          <figure class="p-card__menu">
            <img src="./images/common/img_02.png" alt="スペシャルチーズバーガーの画像" class="p-card__menu--image">
            <figcaption class="p-card__menu--caption c-background-color--card">
              <h2 class="c-title--card c-font-family--mplus1">見出しが入ります</h2>
              <h3 class="c-title--subheading c-font-family--mplus1">小見出しが入ります</h3>
              <p class="c-text--card c-font-family--mplus1">
